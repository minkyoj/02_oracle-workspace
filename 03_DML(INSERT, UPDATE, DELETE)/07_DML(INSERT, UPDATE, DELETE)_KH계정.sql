...
/*
    3. UPDATE
       ...
       [WHERE 조건];    -- > 생략하면 전체행의 모든 행의 데이터가 변경 된다..!! => 그래서 꼭 조건을 기술 해야됨!!
*/
...
-- 노옹철 사원의 급여를 100만원으로 변경! -- 데이터를 주석으로 백업 해두기
SELECT * FROM EMP_SALARY
WHERE EMP_NAME = '노옹철';
...
-- ASIA지역에서 근무하는 사원들 조회
SELECT *
FROM DEPARTMENT
JOIN LOCATION ON (LOCATION_ID = LOCAL_CODE)
JOIN EMP_SALARY ON (DEPT_ID = DEPT_CODE)
...
SET JOB_CODE = 'J9'
WHERE EMP_NAME = '노옹철';
-- ORA-02291: integrity constraint (KH.SYS_C007193) violated - parent key not found
-- FOREIGN KEY 제약조건 위배!!
...
WHERE DEPT_ID = 'D1';
-- ORA-02292: integrity constraint (KH.SYS_C007192) violated - child record found
-- 외래키 제약 조건 위반!!
